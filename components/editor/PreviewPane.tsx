...
export default function PreviewPane({ htmlContent }: PreviewPaneProps) {
  // Convert HTML to markdown for preview (since we're using react-markdown)
  const markdown = htmlToMarkdown(htmlContent)

  return (
    <div className="bg-primary-900 border border-primary-700 rounded-lg p-6 overflow-y-auto max-h-[600px]">
